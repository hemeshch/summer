...
mkdir -p summer_runtime/agent-working-directory
...
echo "     --read-only \\"
echo "     -v ./summer_runtime/agent-working-directory/my-agent:/mnt \\"
echo "     $FULL_IMAGE"
echo ""
