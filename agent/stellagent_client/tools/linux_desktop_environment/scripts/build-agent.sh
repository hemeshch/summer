...
mkdir -p stellagent_runtime/agent-working-directory
...
echo "     --read-only \\"
echo "     -v ./stellagent_runtime/agent-working-directory/my-agent:/mnt \\"
echo "     $FULL_IMAGE"
echo ""
