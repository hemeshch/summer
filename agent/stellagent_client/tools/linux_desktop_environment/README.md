# Linux Desktop Environment for StellAgent

This directory provides a Docker-based Linux environment for the StellAgent bash tool, offering isolated command execution with stateful shell sessions.
...
### 2. Use via StellAgent Debug Interface
...
```python
from stellagent_client.tools.linux_desktop_environment.lazy_agent_manager import ConversationAgent
...
- See main StellAgent documentation for overall architecture